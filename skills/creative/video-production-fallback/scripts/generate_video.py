#!/usr/bin/env python3
"""
Complete video generation example using PIL + FFmpeg fallback.
Generates a professional marketing video with screenshots and avatar.
"""
        ...
        for i in range(num_frames):
            ...
            if scene_name == 'hook':
                ...
                for idx, label in enumerate(feats):
                    ...
                    draw.text((x+100, y+20), ['🌩️','🤖','📐','🚐','💳','📊'][idx], font=icon_font, fill=WHITE)
